...
export default function InviteEmail({ confirmationUrl, siteName = 'PostaFácil', siteUrl = 'https://coconudi.com', recipient }: InviteEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={heading}>Você foi convidado!</Text>
          <Text style={paragraph}>
            Você recebeu um convite para usar o PostaFácil. Clique no botão abaixo para aceitar o convite e configurar sua conta.
          </Text>
